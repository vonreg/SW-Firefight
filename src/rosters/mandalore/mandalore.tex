...
\begin{multicols}{2}
    ...
    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_kryze_A.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_kryze_B.tabl
...
\begin{multicols}{2}
    ...
    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_wren_A.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_wren_B.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_wren_C.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_wren_D.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_wren_E.tabl

    }
\end{multicols}
\vspace{0.6cm}

{\large \textbf{Clan Wren Special Rules}}
\vspace{0.3cm}
\begin{multicols}{2}
    {\scriptsize
...
\begin{multicols}{2}
    ...
    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_saxon_A.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_saxon_B.tabl
...
\begin{minipage}{19cm}
    ...
    Deathwatch can be cautious allies with the Separatist Alliance.
...
\begin{multicols}{2}
    ...
    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_deathwatch_A.tabl
...
\begin{multicols}{2}
    ...
    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_tribe_A.tabl

    \vspace{0.6cm}
    
    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_tribe_B.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_tribe_C.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_tribe_D.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_tribe_E.tabl
...
\begin{minipage}{19cm}
    ...
    Jango Fett can be taken as a mercenary by the Separatist Alliance.
...
\begin{multicols}{2}
    ...
    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_fett_A.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_fett_B.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_fett_C.tabl

    \vspace{0.6cm}

    \setlength\extrarowheight{1.5pt}
    \rowcolors{2}{white}{gray!25}
    \input upgrade_fett_D.tabl
